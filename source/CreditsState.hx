...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Slushi Engine Team'],
			['Andres',		'slushi',					'Creator of Slushi Engine',										'https://twitter.com/Andres_Tik',		'8FD9D1'],
            ['Trock', 		'trock',					'Programmer of Slushi Engine',									'https://twitter.com/Gametrock1',		'0204C7'],
			['Edwhak_KB', 	'Edwhak',					'helped me to improve the NotITG type modcharts',				'hhttps://twitter.com/EDWHAK_KB',		'31C702'],
			[''],
