...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			var menuItem:FlxSprite = new FlxSprite(740, 110 + (i * 110));
			...
			FlxTween.tween(menuItem, {y: menuItem.y + 40}, 0.6, {ease: FlxEase.quadInOut, type: PINGPONG});
			...
			new FlxTimer().start(0.01, function(tmr:FlxTimer)
				{
					if (chikn.angle == -4)
						FlxTween.angle(chikn, chikn.angle, 4, 2, {ease: FlxEase.quartInOut});
					if (chikn.angle == 4)
						FlxTween.angle(chikn, chikn.angle, -4, 2, {ease: FlxEase.quartInOut});
				}, 0);
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 22, 0, "Psych Engine v" + psychEngineVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);


		var versionShit:FlxText = new FlxText(12, FlxG.height - 42, 0, "Slushi Engine v" + slushiEngineVersion,  12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
		var sysComp:FlxText = new FlxText(12, FlxG.height - 62, 0, "Compiled for " + sleBuild, 12);
		sysComp.scrollFactor.set();
		sysComp.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(sysComp);

		var updatecoment:FlxText = new FlxText(12, FlxG.height - 82, 0, "comment update: " + updateComment, 12);
		updatecoment.scrollFactor.set();
		updatecoment.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(updatecoment);
